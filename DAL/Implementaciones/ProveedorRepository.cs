...
namespace DAL.Implementaciones
{
    ...
    public class ProveedorRepository : IProveedorRepository
    {
        ...
        {
            List<Proveedor> proveedores = new List<Proveedor>();
            System.Text.StringBuilder query = new System.Text.StringBuilder("SELECT IdProveedor, IdSimple, Nombre, CUIT, DNI, Direccion, Telefono, Email, RazonSocial, Region, Activo, FechaCreacion, FechaModificacion FROM Proveedor WHERE Activo = 1");
        ...
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            System.Text.StringBuilder query = new System.Text.StringBuilder("SELECT COUNT(*) FROM Proveedor WHERE ");
        ...
        // Métodos del IGenericRepository
