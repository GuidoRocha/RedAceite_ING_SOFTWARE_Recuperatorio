...
{
    /// <summary>
    /// Lógica de negocio para la gestión de remitos.
    /// Coordina las operaciones entre la capa de presentación y la capa de acceso a datos.
    /// </summary>
    public class RemitoLogic
    {
        private readonly IRemitoDAL _remitoRepository;

        /// <summary>
        /// Constructor que inicializa el repositorio de remitos usando el patrón Factory.
        /// </summary>
        public RemitoLogic()
        {
            _remitoRepository = DALFactory.RemitoRepository;
        }
