...
namespace RedAceite_ING_SOFTWARE.Forms
{
    ...
    public partial class FrmModificarProveedor : Form
    {
        ...
        public FrmModificarProveedor(Guid idProveedor)
        {
            InitializeComponent();
            this.Tag = "Titulo_FrmModificarProveedor";
        ...
        /// <summary>
        /// Carga los datos del proveedor desde la base de datos y los muestra en el formulario.
        /// </summary>
        private void CargarDatosProveedor()
        {
            try
            {
                ...
                {
                    txtCUIT.Text = $"{cuit.Substring(0, 2)}-{cuit.Substring(2, 8)}-{cuit.Substring(10, 1)}";
                }
                else
                {
                    txtCUIT.Text = cuit;
                ...
                {
                    int index = cmbRegion.FindStringExact(_proveedorOriginal.Region);
                    if (index >= 0)
                    {
